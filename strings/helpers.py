...
• /welcomemessage [ᴏɴ / ᴏғғ] ➠ ᴍᴇᴍʙᴇʀ ᴡᴇʟᴄᴏᴍᴇ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ

• /tgm (Or) /telegraph ➠ ᴜᴘʟᴏᴀᴅs ᴀ ᴘʜᴏᴛᴏ (ᴜɴᴅᴇʀ 𝟻ᴍʙ) ᴛᴏ ᴛʜᴇ ᴄʟᴏᴜᴅ ᴀɴᴅ ɢɪᴠᴇs ᴀ ʟɪɴᴋ.

• /tagall ➠  ᴛᴀɢ ᴍᴇᴍʙᴇʀs ʙʏ ɪɴᴅɪᴠɪᴅᴜᴀʟ ᴍᴇssᴀɢᴇs

• /all ➠ ᴍᴇɴᴛɪᴏɴ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀ

• /unpinall ➠  ᴜɴᴘɪɴ ᴀʟʟ ᴍᴇssᴀɢᴇs ɪɴ ɢʀᴏᴜᴘ

• /carbon ➠  ᴄʀᴇᴀᴛᴇ ᴄᴀʀʙᴏɴ ɪᴍᴀɢᴇ

• /couples ➠ ᴄʀᴇᴀᴛᴇ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ

• /pin & /unpin ➠ ᴘɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ɢʀᴏᴜᴘ & ᴜɴᴘɪɴ ᴀ ᴍᴇssᴀɢᴇ ɪɴ ɢʀᴏᴜᴘ

• /setphoto & /removephoto ➠ sᴇᴛ & ʀᴇᴍᴏᴠᴇ ɢʀᴏᴜᴘ ᴘʜᴏᴛᴏ

• /settitle ➠ sᴇᴛ ɢʀᴏᴜᴘ ᴛɪᴛʟᴇ

• /setdescription ➠ sᴇᴛ ɢʀᴏᴜᴘ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ

• /imposter ➠ ᴄʜᴇᴄᴋ, ᴡʜɪᴄʜ ᴜsᴇʀ ᴄʜᴀɴɢᴇ ᴛʜᴇɪʀ ᴜsᴇʀɴᴀᴍᴇ & ɴᴀᴍᴇ

• /tr ➠ ᴛʀᴀɴsʟᴀᴛᴇ ᴀ ᴍᴇssᴀɢᴇ

• /id ➠ ɪᴅ ɪɴғᴏʀᴍᴀᴛɪᴏɴ

• /clean ➠ ʀᴇᴍᴏᴠᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs ғʀᴏᴍ ɢʀᴏᴜᴘ
